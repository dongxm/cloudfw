...
//    static {
//        JEDIS_IP = PropertiesUtils.getPropert("redis_server_ip");
//        JEDIS_PORT = Integer.valueOf(PropertiesUtils.getPropert("redis_server_port"));
//        JEDIS_AUTH = PropertiesUtils.getPropert("redis_server_auth");
...
//        jedisPool = new JedisPool(config, JEDIS_IP, JEDIS_PORT, 60000, JEDIS_AUTH);
//    }
    ...
    private static class JedisUtilLoader {
    ...
    public static JedisUtil getInstance() {
        instance = JedisUtilLoader.instance;
        return instance;
